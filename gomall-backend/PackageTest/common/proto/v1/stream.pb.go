...
const file_stream_proto_rawDesc = "" +
	"\n" +
	"\fstream.proto\x12\x05proto\"#\n" +
	"\rStreamReqData\x12\x12\n" +
	"\x04data\x18\x01 \x01(\tR\x04data\"#\n" +
	"\rStreamResData\x12\x12\n" +
	"\x04data\x18\x01 \x01(\tR\x04data2\xbc\x01\n" +
	"\aGreeter\x129\n" +
	"\tGetStream\x12\x14.proto.StreamReqData\x1a\x14.proto.StreamResData0\x01\x129\n" +
	"\tPutStream\x12\x14.proto.StreamReqData\x1a\x14.proto.StreamResData(\x01\x12;\n" +
	"\tAllStream\x12\x14.proto.StreamReqData\x1a\x14.proto.StreamResData(\x010\x01B\aZ\x05./;v1b\x06proto3"
